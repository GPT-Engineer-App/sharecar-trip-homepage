...
import { CircleUser, Menu, Package2, Home, LogIn, User, Search, Plus, Phone } from "lucide-react";
...
const navItems = [
  ...
  { to: "/contact-us", icon: <Phone className="h-4 w-4" />, title: "Contact Us" },
];
